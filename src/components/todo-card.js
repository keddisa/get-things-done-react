...
import { selectTask, decrementPriority, incrementPriority, markFinished, reopenTask, deleteTask } from '../actions';
...
const TodoCard = (props) => {
    ...
    return (<div className="todo-card">
        ...
        <div className="todo-details">
            ...
            <div className="todo-cagegory">
                Category: {props.task.category}
            </div>
        </div>
        <div className="todo-cta">
            <div className="todo-buttons">
                <button className="button-todo-dark" onClick={() => {props.selectTask(props.task.id)}}>Edit</button>
                {renderCloseOrOpen()}
...
export default connect(mapStateToProps, { selectTask, decrementPriority, incrementPriority, markFinished, reopenTask, deleteTask })(TodoCard)